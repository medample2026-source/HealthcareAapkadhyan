...
const DoctorReports = () => {
  ...
  const searchPatient = async (e) => {
    ...
    try {
      ...
      const res = await API.get(
        `/reports/doctor/search-patient/${cleanPatientId}`,
      );
  ...
  const fetchPatientReports = async (id = searchedPatientId) => {
    ...
    try {
      ...
      const res = await API.get(`/reports/doctor/patient/${id}`);
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      await API.post(`/reports/doctor/upload/${searchedPatientId}`, formData, {
        headers: {
      ...
      const fileInput = document.getElementById("doctor-report-file");
        ...
        <div className="flex flex-col justify-between gap-5 md:flex-row md:items-center">
          <div>
            ...
            <h1 className="text-3xl font-black md:text-4xl">
              Search patient and upload medical reports
            </h1>

            <p className="mt-3 max-w-2xl text-cyan-50">
              Use the patient&apos;s unique ID or QR-based ID to access
              doctor-visible reports and upload prescriptions after checkup.
            </p>
          </div>
          ...
          <section className="rounded-[2rem] border border-white/70 bg-white/85 p-5 shadow-xl shadow-cyan-100/60 backdrop-blur-xl md:p-7">
            <div className="mb-6 flex gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Upload checkup reports, diagnosis notes, prescriptions, or
            ...
            <form onSubmit={handleUpload} className="grid gap-5 lg:grid-cols-2">
              <Input
                ...
                placeholder="Example: Fever Checkup Prescription"
                required
              />
              ...
              <Textarea
                ...
                onChange={handleChange}
                placeholder="Short details about this report..."
              />
              ...
              <Textarea
                ...
                onChange={handleChange}
                placeholder="Example: Mild fever with throat infection..."
              />
              ...
              <div className="lg:col-span-2">
                <Textarea
                  ...
                  onChange={handleChange}
                  placeholder="Example: Paracetamol twice daily after food for 3 days..."
                />
              </div>
          ...
          <section className="rounded-[2rem] border border-white/70 bg-white/85 p-5 shadow-xl shadow-cyan-100/60 backdrop-blur-xl md:p-7">
            <div className="mb-6 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Doctor-visible reports for this patient.
                </p>
              </div>
            ...
            {reportsLoading ? (
              ...
              <div className="rounded-[2rem] border border-dashed border-cyan-200 bg-cyan-50/60 p-10 text-center">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Upload a report or ask patient to make reports doctor-visible.
                </p>
              </div>
            ) : (
...
const ReportCard = ({ report }) => {
  ...
  const uploaderName = uploadedByDoctor
    ...
    : report.uploadedBy?.fullName || "Patient";
        ...
        <div className="flex gap-4">
          ...
          <div>
            <div className="mb-2 flex flex-wrap items-center gap-2">
              ...
              >
                {uploadedByDoctor ? "Doctor Uploaded" : "Patient Uploaded"}
              </span>
            </div>
